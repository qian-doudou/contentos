...
const primaryActions = [
  ...
  { href: '/scripts', title: '继续已有脚本', description: '查找已经生成的脚本，继续修改、提交审核或查看历史版本。', action: '打开脚本库', icon: BookOpenText, featured: false },
...
export function AiHubPage() {
  ...
  return <div className="space-y-7">
    ...
    <section className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
      ...
      <MetricCard label="待写脚本" value={workbench.scriptsToWrite} helper="已有选题或需要继续完善的脚本" href="/scripts" icon={FilePenLine} />
