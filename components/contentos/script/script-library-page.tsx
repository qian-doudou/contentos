...
export function ScriptLibraryPage() {
  ...
  return <div className="space-y-6">
    <header className="flex flex-wrap items-start justify-between gap-4">
      ...
      <div className="flex flex-wrap gap-2"><Button variant="outline" nativeButton={false} render={<Link href="/contents" />}><History />内容工作台</Button><Button nativeButton={false} render={<Link href="/scripts/new" />}><Sparkles />写新脚本</Button></div>
    </header>
